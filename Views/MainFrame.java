...
public class MainFrame  extends javax.swing.JFrame{
    ...
    public MainFrame(){
        Services.RDP.Server.Server server = new Services.RDP.Server.Server(); 
        ...
        this.addWindowListener(new java.awt.event.WindowAdapter(){
            ...
            public void windowClosing(java.awt.event.WindowEvent e){
                ...
                if(choice==javax.swing.JOptionPane.OK_OPTION){
                    ...
                    try {
                        Services.FTPServer.Server.Start.stopServer();
                    } catch (Exception ex) {
    ...
    private void updateStatus(){
        try {
            if(Services.RDP.Server.Server.running()){
                ...
                if(e.getButton() == java.awt.event.MouseEvent.BUTTON1){
                    if(onlineContactChoice == false){
                        ...
                        if(choice == javax.swing.JOptionPane.OK_OPTION){
                            ...
                            mainPanel.add(new OnlineContactPanel().getOnlineContactPanel());  
                            mainPanel.setPreferredSize(new java.awt.Dimension(rightPnWidth, height - footerHeight));
                            mainPanel.revalidate();
                            mainPanel.repaint();
                        }
                ...
                if(e.getButton() == java.awt.event.MouseEvent.BUTTON1){
                    if(ftpServerChoice == false){
                        ...
                        if(choice == javax.swing.JOptionPane.OK_OPTION){
                            ...
                            mainPanel.add(new FileTransferPanel().GetFileTransferPanel()); 
                            mainPanel.setPreferredSize(new java.awt.Dimension(rightPnWidth, height - footerHeight));
                            mainPanel.revalidate();
                            mainPanel.repaint();
                        }
